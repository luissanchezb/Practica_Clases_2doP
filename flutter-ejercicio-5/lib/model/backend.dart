...
class Backend {
  ...
  final _emails = [
    Email(
      id: 631,
      from: 'LuisSnchez@programming.com',
      subject: 'SANCHEZ',
    ...
    Email(
      id: 522,
      from: 'pamelavera@programming.com',
    ...
    Email(
      id: 963,
      from: 'omarponce@programming.com',
    ...
    Email(
      id: 835,
      from: 'Angelomero@programminglanguage.com',
